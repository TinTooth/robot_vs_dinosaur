robots = {
    ...
    'robot2' : {'name': 'Deathscythe',
            ...
            'weapon2': {'name': 'Knee-Strike','attack_power':50,'win':'The strike was true!','type':'precision'},
            'weapon3': {'name': 'Beam Scythe','attack_power':60,'win':'The Scythe sliced the Dinosaur Deep!','type':'quick'},
            },
    'robot3' : {'name': 'SandRock',
            'health':100,
            'weapon1': {'name': 'Vulcan Gun','attack_power':60,'win':'The bullets find the Dinosaur!','type':'power'},
            'weapon2': {'name': 'Cross-Crusher','attack_power':40,'win':'A Dinosaur limb was crushed!','type':'precision'},
            'weapon3': {'name': 'Heated Blades','attack_power':50,'win':'The Dinosaur was burned badly!','type':'quick'},
            },
}
...
dinosaurs = {
    'dinosaur1' : {'name': 'T-Rex','health':100, 'attack_power': 50,
                'attack1': {'name': 'Tail Swipe','attack_power':10,'win':'The T-Rex\'s Tail powered into his Robot!','type':'power'},
    ...
    'dinosaur2' : {'name': 'Triceratops','health':140, 'attack_power': 40,
                'attack1': {'name': 'Tail Swipe','attack_power':10,'win':'The Triceratop\'s Tail powered into his Robot!','type':'power'},
                'attack2': {'name': 'Stomp','attack_power':-10,'win':'The Triceratop Stompped his Robot back!','type':'precision'},
                'attack3': {'name': 'Spike Head-Butt','attack_power':0,'win':'The Triceratop\'s Spikes struck true!','type':'quick'},
},
    'dinosaur3' : {'name': 'Terradactyl','health':70, 'attack_power': 60,
                'attack1': {'name': 'Nose Dive','attack_power':10,'win':'The Terradactyl\'s beak pierced the Robot!','type':'power'},
                'attack2': {'name': 'Wing Gust','attack_power':-10,'win':'The Terradactyl\'s gust hit the Robot back!','type':'precision'},
                'attack3': {'name': 'Scratch','attack_power':0,'win':'The Terradactyl\'s claws cut deep!','type':'quick'},
},
